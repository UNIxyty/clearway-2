...
| Country | ICAO | Link | Status in JSON | Reason | Script |
|---|---|---|---|---|---|
| Finland | EF | https://ais.fi/eaip/ | correct | No dedicated scraper yet | - |
...
| Ireland | EI | https://www.airnav.ie/air-traffic-management/aeronautical-information-management/aip-package#Part_III_-_Aerodromes_(AD) | correct | No dedicated scraper yet | - |
...
| Portugal | LP | https://ais.nav.pt/wp-content/uploads/AIS_Files/eAIP_Current/eAIP_Online/eAIP/html/index.html | correct | No dedicated scraper yet | - |
...
| Spain | LE | https://aip.enaire.es/AIP/AIP-en.html | correct | No dedicated scraper yet | - |
