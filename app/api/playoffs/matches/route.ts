...
export async function GET() {
  ...
  const { data: matchRows, error } = await supabase
    ...
    .select('id, match_code, round, match_number, kickoff_at, venue, city, is_locked, home_score, away_score, ot_home_score, ot_away_score, pen_home_score, pen_away_score, winner_team_id, home_team_id, away_team_id')
    .order('match_number');
