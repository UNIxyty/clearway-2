...
export const metadata: Metadata = {
  title: "Pickem Admin (Legacy) | Clearway",
  description: "Legacy tabbed Pickem admin — retains Dev Mode tooling alongside the unified console sections.",
...
/*
 * Legacy tabbed admin (Match Results / Group Standings / Pick Locks / Dev Mode).
 * The first three tabs now also live as sections in the unified console at
 * /pickem/admin; this route is preserved because it is the only home of the
 * developer-only Dev Mode simulation tooling, which is out of scope for the
 * console's 9 sections.
 */
export default async function PickemAdminLegacyPage() {
