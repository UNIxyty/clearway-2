...
// proper page (portal redesign). Same data source and 10-second poll as the
// old overlay: GET /api/country-service-status (Supabase statuses + all
// known countries + live debug-runner countries). Read-only here; admins
// still edit states at /admin/country-service-status.
  ...
  return (
    <PortalShell>
      <div className="max-w-[1560px] px-[30px] pb-10 pt-[26px]">
        <h1 className="m-0 mb-[5px] text-[26px] font-extrabold tracking-[-0.02em]">Service status</h1>
        <p className="m-0 mb-5 text-[15px] leading-normal text-[#6c7079]">
          Where AIP retrieval currently works, by country. States are set by the Clearway team as
