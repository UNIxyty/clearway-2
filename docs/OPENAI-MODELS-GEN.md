...
Use these with **Chat Completions** for [GEN 1.2 rewriting](GEN-REWRITE-PROMPT.md) (GENERAL and Part 4) and for [AIP data extraction](AIP-EXTRACT-PROMPT.md). Set `OPENAI_MODEL` in `.env` or when running the sync server.
