...
// service-checks: persisted availability results (lib/service-checker.ts);
// help-attachments: Help Centre uploads (lib/help). Keep in sync with
// lib/utils/path-safety.ts — the bundler resolves @/lib/storage to THIS file.
