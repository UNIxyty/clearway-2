...
async function fetchS3ObjectBytes(key) {
  ...
  try {
    const bytes = await readStorageFile(key);
...
const SCRAPER_COUNTRY_SPECS = [
  ...
  },
  {
    country: "Albania",
    prefixes: ["LA"],
    script: "scripts/web-table-scrapers/albania-aip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "albania-aip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "albania-aip", "GEN"),
  },
  {
    country: "Armenia",
    prefixes: ["UD"],
    script: "scripts/web-table-scrapers/armenia-eaip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "armenia-eaip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "armenia-eaip", "GEN"),
  },
  {
    country: "Austria",
    prefixes: ["LO"],
    script: "scripts/web-table-scrapers/austria-eaip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "austria-eaip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "austria-eaip", "GEN"),
  },
  {
    country: "Bahrain",
    prefixes: ["OB"],
  ...
  },
  {
    country: "Belgium",
    prefixes: ["EB"],
    script: "scripts/web-table-scrapers/belgium-eaip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "belgium-eaip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "belgium-eaip", "GEN"),
  },
  {
    country: "Belarus",
    prefixes: ["UM"],
  ...
  },
  {
    ...
    prefixes: ["LK"],
    script: "scripts/web-table-scrapers/czech-republic-eaip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "czech-republic-eaip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "czech-republic-eaip", "GEN"),
  },
  {
    country: "Denmark",
    prefixes: ["EK"],
    script: "scripts/web-table-scrapers/denmark-eaip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "denmark-eaip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "denmark-eaip", "GEN"),
  },
  {
    country: "Ecuador",
    prefixes: ["SE"],
  ...
  },
  {
    country: "Estonia",
    prefixes: ["EE"],
    script: "scripts/web-table-scrapers/estonia-eaip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "estonia-eaip", "AD2"),
  ...
  },
  {
    country: "France",
    prefixes: ["LF"],
    script: "scripts/web-table-scrapers/france-eaip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "france-eaip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "france-eaip", "GEN"),
  },
  {
    country: "Germany",
    prefixes: ["ED", "ET"],
    script: "scripts/web-table-scrapers/germany-eaip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "germany-eaip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "germany-eaip", "GEN"),
  },
  {
    country: "Georgia",
    prefixes: ["UG"],
  ...
  },
  {
    country: "Greece",
    prefixes: ["LG"],
    script: "scripts/web-table-scrapers/greece-eaip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "greece-eaip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "greece-eaip", "GEN"),
  },
  {
    country: "Guatemala",
    prefixes: ["MG"],
  ...
  },
  {
    country: "Lithuania",
    prefixes: ["EY"],
    script: "scripts/web-table-scrapers/lithuania-eaip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "lithuania-eaip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "lithuania-eaip", "GEN"),
  },
  {
    country: "Kuwait",
    prefixes: ["OK"],
  ...
  },
  {
    country: "Netherlands",
    prefixes: ["EH"],
    script: "scripts/web-table-scrapers/netherlands-eaip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "netherlands-eaip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "netherlands-eaip", "GEN"),
  },
  {
    country: "Norway",
    prefixes: ["EN"],
    script: "scripts/web-table-scrapers/norway-eaip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "norway-eaip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "norway-eaip", "GEN"),
  },
  {
    country: "Pakistan",
    prefixes: ["OP"],
  ...
  },
  {
    country: "Romania",
    prefixes: ["LR"],
    script: "scripts/web-table-scrapers/romania-eaip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "romania-eaip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "romania-eaip", "GEN"),
  },
  {
    country: "Rwanda",
    prefixes: ["HR"],
  ...
  },
  {
    country: "Slovenia",
    prefixes: ["LJ"],
    script: "scripts/web-table-scrapers/slovenia-eaip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "slovenia-eaip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "slovenia-eaip", "GEN"),
  },
  {
    country: "Spain",
    prefixes: ["LE"],
  ...
  },
  {
    ...
    prefixes: ["EG"],
    script: "scripts/web-table-scrapers/united-kingdom-aip-interactive.mjs",
    ad2Dir: join(PROJECT_ROOT, "downloads", "united-kingdom-aip", "AD2"),
    genDir: join(PROJECT_ROOT, "downloads", "united-kingdom-aip", "GEN"),
  },
  {
    country: "Uzbekistan",
    prefixes: ["UZ"],
...
async function uploadToS3() {
  ...
  await saveFile("aip/ead-aip-extracted.json", body);
}
...
async function uploadPerIcaoToS3(icao, data, namespace = "ead") {
  ...
  await saveFile(namespace === "scraper" ? `aip/scraper/${icao}.json` : `aip/ead/${icao}.json`, body);
}
